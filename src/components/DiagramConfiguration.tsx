...
function DiagramConfiguration({diagramConfiguration, setDiagramConfiguration}: ConfigurationPanelProps) {


    const handleNumberChange = (value: number, param: keyof ChordDiagramParams) => {
    ...
    const handleBooleanChange = (value: boolean, param: keyof ChordDiagramParams) => {
        setDiagramConfiguration({
            ...diagramConfiguration,
            [param]: value
        });
    ...
    const handleArrayChange = (value: string, param: keyof ChordDiagramParams) => {
        setDiagramConfiguration({
            ...diagramConfiguration,
            [param]: value.split(",")
        });
    ...
    const handleStringChange = (value: string, param: keyof ChordDiagramParams) => {
        setDiagramConfiguration({
            ...diagramConfiguration,
            [param]: value
        });
        ...
        <Wraper>
            ...
            <Row>
                <TextField
                    ...
                    onBlur={(e) => handleNumberChange(parseInt(e.target.value), "numOfStrings")}
                />
                <TextField
                    label="# of Frets"
                    variant="standard"
                    defaultValue={diagramConfiguration.numOfFrets}
                    onBlur={(e) => handleNumberChange(parseInt(e.target.value), "numOfFrets")}
                />
            </Row>
            <Row>
                <TextField
                    ...
                    onBlur={(e) => handleNumberChange(parseInt(e.target.value), "stringWidth")}
                />
                <TextField
                    label="Frets Width"
                    variant="standard"
                    defaultValue={diagramConfiguration.fretsWidth}
                    onBlur={(e) => handleNumberChange(parseInt(e.target.value), "fretsWidth")}
                />
            </Row>
            <Row>
                <TextField
                    ...
                    onBlur={(e) => handleNumberChange(parseInt(e.target.value), "animationDuration")}
                />
            </Row>
            <Row>
                <FormControlLabel
                ...
                />
                <FormControlLabel
                    control={<Switch checked={diagramConfiguration.showBridgeLabel} onChange={(e) => handleBooleanChange(e.target.checked, "showBridgeLabel")}/>}
                    label="Show Bridge Labels"
                />
            </Row>
            <Row>
                <FormControlLabel
                    control={<Switch checked={diagramConfiguration.showFingerLabels} onChange={(e) => handleBooleanChange(e.target.checked, "showFingerLabels")}/>}
                    label="Show Finger Label"
                />
                <FormControlLabel
                    control={<Switch checked={diagramConfiguration.showOpenStringsLabels} onChange={(e) => handleBooleanChange(e.target.checked, "showOpenStringsLabels")}/>}
                    label="Show Open Strings Labels"
                />
            </Row>
            <Row>
                <FormControlLabel
                    control={<Switch checked={diagramConfiguration.showTuning} onChange={(e) => handleBooleanChange(e.target.checked, "showTuning")}/>}
                    label="Show Tuning"
                />
                <TextField
                    label="Tuning"
            ...
            <Row>
                ...
                <TextField
                    ...
                    onBlur={(e) => handleNumberChange(parseInt(e.target.value), "fontSize")}
                />
            </Row>
            <Row>
                <TextField
                ...
                <TextField
                    ...
                    onBlur={(e) => handleNumberChange(parseInt(e.target.value), "fontWeight")}
                />
            </Row>
        </Wraper>
    );
